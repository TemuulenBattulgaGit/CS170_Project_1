...
from structure import UniformCostSearch
...
def test_uniform_cost_search():
    ...
    start_state = [1, 2, 3, 4, 5, 6, 7, 0, 8]  # Just one move away from goal for simplicity
    goal_state = [1, 2, 3, 4, 5, 6, 7, 8, 0]

    # Instantiate UniformCostSearch with the start and goal state
